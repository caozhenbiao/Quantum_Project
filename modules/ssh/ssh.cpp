...
int cssh::login_pubkey(const char* ip, unsigned short port, const char* user, const char* file) {
	peerinfo pinfo;
	...
	libssh2_userauth_publickey_fromfile(pinfo.session, user, file,file,file);
