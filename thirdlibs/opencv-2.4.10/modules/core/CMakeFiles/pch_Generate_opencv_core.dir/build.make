...
modules/core/precomp.hpp.gch/opencv_core_Release.gch: lib/libopencv_core_pch_dephelp.a
	...
	cd /mnt/hgfs/smartx1.0/modules/opencv/opencv-2.4.10/modules/core && /usr/bin/cmake -E make_directory /mnt/hgfs/smartx1.0/modules/opencv/opencv-2.4.10/modules/core/precomp.hpp.gch
	cd /mnt/hgfs/smartx1.0/modules/opencv/opencv-2.4.10/modules/core && /usr/bin/c++ -O2 -DNDEBUG -DNDEBUG -fPIC -isystem"/mnt/hgfs/smartx1.0/modules/opencv/opencv-2.4.10/3rdparty/zlib" -I"/mnt/hgfs/smartx1.0/modules/opencv/opencv-2.4.10/modules/dynamicuda/include" -I"/mnt/hgfs/smartx1.0/modules/opencv/opencv-2.4.10/modules/core" -I"/mnt/hgfs/smartx1.0/modules/opencv/opencv-2.4.10/modules/core/src" -I"/mnt/hgfs/smartx1.0/modules/opencv/opencv-2.4.10/modules/core/include" -isystem"/mnt/hgfs/smartx1.0/modules/opencv/opencv-2.4.10" -fsigned-char -W -Wall -Werror=return-type -Werror=address -Werror=sequence-point -Wformat -Werror=format-security -Wmissing-declarations -Wmissing-prototypes -Wstrict-prototypes -Wundef -Winit-self -Wpointer-arith -Wshadow -Wsign-promo -Wno-narrowing -Wno-delete-non-virtual-dtor -Wno-unnamed-type-template-args -fdiagnostics-show-option -pthread -march=i686 -fomit-frame-pointer -msse -msse2 -msse3 -mfpmath=sse -ffunction-sections -DCVAPI_EXPORTS -x c++-header -o /mnt/hgfs/smartx1.0/modules/opencv/opencv-2.4.10/modules/core/precomp.hpp.gch/opencv_core_Release.gch /mnt/hgfs/smartx1.0/modules/opencv/opencv-2.4.10/modules/core/precomp.hpp
...
modules/core/precomp.hpp: modules/core/src/precomp.hpp
	...
	cd /mnt/hgfs/smartx1.0/modules/opencv/opencv-2.4.10/modules/core && /usr/bin/cmake -E copy /mnt/hgfs/smartx1.0/modules/opencv/opencv-2.4.10/modules/core/src/precomp.hpp /mnt/hgfs/smartx1.0/modules/opencv/opencv-2.4.10/modules/core/precomp.hpp
...
modules/core/CMakeFiles/pch_Generate_opencv_core.dir/clean:
	cd /mnt/hgfs/smartx1.0/modules/opencv/opencv-2.4.10/modules/core && $(CMAKE_COMMAND) -P CMakeFiles/pch_Generate_opencv_core.dir/cmake_clean.cmake
